...
class SkriningCKG extends TbObject
{
    ...
    {   
        $this->pasien_ckg_id = isset($data['pasien_ckg_id']) ? $data['pasien_ckg_id'] : null;
        $this->pasien_nik = isset($data['pasien_nik']) ? $data['pasien_nik'] : null;
        $this->pasien_nama = isset($data['pasien_nama']) ? $data['pasien_nama'] : null;
        $this->pasien_jenis_kelamin = isset($data['pasien_jenis_kelamin']) ? $data['pasien_jenis_kelamin'] : null;
        $this->pasien_tgl_lahir = isset($data['pasien_tgl_lahir']) ? $data['pasien_tgl_lahir'] : null;
        $this->pasien_pekerjaan = isset($data['pasien_pekerjaan']) ? $data['pasien_pekerjaan'] : null;
        $this->pasien_usia = isset($data['pasien_usia']) ? $data['pasien_usia'] : null;
        $this->pasien_provinsi_satusehat = isset($data['pasien_provinsi_satusehat']) ? $data['pasien_provinsi_satusehat'] : null;
        $this->pasien_kabkota_satusehat = isset($data['pasien_kabkota_satusehat']) ? $data['pasien_kabkota_satusehat'] : null;
        $this->pasien_kecamatan_satusehat = isset($data['pasien_kecamatan_satusehat']) ? $data['pasien_kecamatan_satusehat'] : null;
        $this->pasien_kelurahan_satusehat = isset($data['pasien_kelurahan_satusehat']) ? $data['pasien_kelurahan_satusehat'] : null;
        $this->pasien_provinsi_sitb = isset($data['pasien_provinsi_sitb']) ? $data['pasien_provinsi_sitb'] : null;
        $this->pasien_kabkota_sitb = isset($data['pasien_kabkota_sitb']) ? $data['pasien_kabkota_sitb'] : null;
        $this->pasien_kecamatan_sitb = isset($data['pasien_kecamatan_sitb']) ? $data['pasien_kecamatan_sitb'] : null;
        $this->pasien_kelurahan_sitb = isset($data['pasien_kelurahan_sitb']) ? $data['pasien_kelurahan_sitb'] : null;
        $this->pasien_alamat = isset($data['pasien_alamat']) ? $data['pasien_alamat'] : null;
        $this->pasien_no_handphone = isset($data['pasien_no_handphone']) ? $data['pasien_no_handphone'] : null;
        $this->periksa_faskes_satusehat = isset($data['periksa_faskes_satusehat']) ? $data['periksa_faskes_satusehat'] : null;
        $this->periksa_faskes_sitb = isset($data['periksa_faskes_sitb']) ? $data['periksa_faskes_sitb'] : null;
        $this->periksa_tgl = isset($data['periksa_tgl']) ? $data['periksa_tgl'] : null;
        $this->hasil_berat_badan = isset($data['hasil_berat_badan']) ? $data['hasil_berat_badan'] : null;
        $this->hasil_tinggi_badan = isset($data['hasil_tinggi_badan']) ? $data['hasil_tinggi_badan'] : null;
        $this->hasil_imt = isset($data['hasil_imt']) ? $data['hasil_imt'] : null;
        $this->hasil_gds = isset($data['hasil_gds']) ? $data['hasil_gds'] : null;
        $this->hasil_gdp = isset($data['hasil_gdp']) ? $data['hasil_gdp'] : null;
        $this->hasil_gdpp = isset($data['hasil_gdpp']) ? $data['hasil_gdpp'] : null;
        $this->risiko_pernah_terdiagnosis = isset($data['risiko_pernah_terdiagnosis']) ? $data['risiko_pernah_terdiagnosis'] : null;
        $this->risiko_kekurangan_gizi = isset($data['risiko_kekurangan_gizi']) ? $data['risiko_kekurangan_gizi'] : null;
        $this->risiko_merokok = isset($data['risiko_merokok']) ? $data['risiko_merokok'] : null;
        $this->risiko_perokok_pasif = isset($data['risiko_perokok_pasif']) ? $data['risiko_perokok_pasif'] : null;
        $this->risiko_lansia = isset($data['risiko_lansia']) ? $data['risiko_lansia'] : null;
        $this->risiko_ibu_hamil = isset($data['risiko_ibu_hamil']) ? $data['risiko_ibu_hamil'] : null;
        $this->risiko_dm = isset($data['risiko_dm']) ? $data['risiko_dm'] : null;
        $this->risiko_hipertensi = isset($data['risiko_hipertensi']) ? $data['risiko_hipertensi'] : null;
        $this->risiko_hiv_aids = isset($data['risiko_hiv_aids']) ? $data['risiko_hiv_aids'] : null;
        $this->gejala_batuk = isset($data['gejala_batuk']) ? $data['gejala_batuk'] : null;
        $this->gejala_bb_turun = isset($data['gejala_bb_turun']) ? $data['gejala_bb_turun'] : null;
        $this->gejala_demam_hilang_timbul = isset($data['gejala_demam_hilang_timbul']) ? $data['gejala_demam_hilang_timbul'] : null;
        $this->gejala_lesu_malaise = isset($data['gejala_lesu_malaise']) ? $data['gejala_lesu_malaise'] : null;
        $this->gejala_berkeringat_malam = isset($data['gejala_berkeringat_malam']) ? $data['gejala_berkeringat_malam'] : null;
        $this->gejala_pembesaran_getah_bening = isset($data['gejala_pembesaran_getah_bening']) ? $data['gejala_pembesaran_getah_bening'] : null;
        $this->kontak_pasien_tbc = isset($data['kontak_pasien_tbc']) ? $data['kontak_pasien_tbc'] : null;
        $this->hasil_skrining_tbc = isset($data['hasil_skrining_tbc']) ? $data['hasil_skrining_tbc'] : null;
        $this->terduga_tb = isset($data['terduga_tb']) ? $data['terduga_tb'] : null;
        $this->tindak_lanjut_tb = isset($data['tindak_lanjut_tb']) ? $data['tindak_lanjut_tb'] : null;
        $this->pemeriksaan_tb_metode = isset($data['pemeriksaan_tb_metode']) ? $data['pemeriksaan_tb_metode'] : null;
        $this->pemeriksaan_tb_bta = isset($data['pemeriksaan_tb_bta']) ? $data['pemeriksaan_tb_bta'] : null;
        $this->pemeriksaan_tb_tcm = isset($data['pemeriksaan_tb_tcm']) ? $data['pemeriksaan_tb_tcm'] : null;
    }
    ...
    public function toDbRecord(): array {
        ...
        $return = [
            ...
            'unit_pelaksana_id' => $this->periksa_faskes_sitb ? $this->periksa_faskes_sitb : '',
            'warga_negara_id' => '1', // WNI
            'nama_peserta' => $this->pasien_nama,
            'alamat_ktp' => $this->pasien_alamat ? $this->pasien_alamat : '',
            ...
            'alamat_domisili' => $this->pasien_alamat ? $this->pasien_alamat : '',
            ...
            'nik' => $this->pasien_nik,
            'pekerjaan_id' => $this->pasien_pekerjaan ? $this->pasien_pekerjaan : '18',
            ...
            'berat_badan' => $this->hasil_berat_badan ? $this->hasil_berat_badan : 0,
            'tinggi_badan' => $this->hasil_tinggi_badan ? $this->hasil_tinggi_badan : 0,
            'imt' => $this->hasil_imt,
            'status_gizi_id' => $this->convertYaTidak($this->risiko_kekurangan_gizi),
            'riwayat_kontak_tb_id' => $this->convertAdaRiwayatKontak($this->kontak_pasien_tbc, 'Tidak'),
            'jenis_kontak_id' => $this->convertAdaRiwayatKontak($this->kontak_pasien_tbc, 'Tidak'),
            ...
            'dirujuk_ke_id' => $this->periksa_faskes_sitb ? $this->periksa_faskes_sitb : '',
