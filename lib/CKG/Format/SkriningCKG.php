...
class SkriningCKG extends TbObject
{
    ...
    {   
        $this->pasien_ckg_id = $data['pasien_ckg_id'] ?? null;
        $this->pasien_nik = $data['pasien_nik'] ?? null;
        $this->pasien_nama = $data['pasien_nama'] ?? null;
        $this->pasien_jenis_kelamin = $data['pasien_jenis_kelamin'] ?? null;
        $this->pasien_tgl_lahir = $data['pasien_tgl_lahir'] ?? null;
        $this->pasien_pekerjaan = $data['pasien_pekerjaan'] ?? null;
        $this->pasien_usia = $data['pasien_usia'] ?? null;
        $this->pasien_provinsi_satusehat = $data['pasien_provinsi_satusehat'] ?? null;
        $this->pasien_kabkota_satusehat = $data['pasien_kabkota_satusehat'] ?? null;
        $this->pasien_kecamatan_satusehat = $data['pasien_kecamatan_satusehat'] ?? null;
        $this->pasien_kelurahan_satusehat = $data['pasien_kelurahan_satusehat'] ?? null;
        $this->pasien_provinsi_sitb = $data['pasien_provinsi_sitb'] ?? null;
        $this->pasien_kabkota_sitb = $data['pasien_kabkota_sitb'] ?? null;
        $this->pasien_kecamatan_sitb = $data['pasien_kecamatan_sitb'] ?? null;
        $this->pasien_kelurahan_sitb = $data['pasien_kelurahan_sitb'] ?? null;
        $this->pasien_alamat = $data['pasien_alamat'] ?? null;
        $this->pasien_no_handphone = $data['pasien_no_handphone'] ?? null;
        $this->periksa_faskes_satusehat = $data['periksa_faskes_satusehat'] ?? null;
        $this->periksa_faskes_sitb = $data['periksa_faskes_sitb'] ?? null;
        $this->periksa_tgl = $data['periksa_tgl'] ?? null;
        $this->hasil_berat_badan = $data['hasil_berat_badan'] ?? null;
        $this->hasil_tinggi_badan = $data['hasil_tinggi_badan'] ?? null;
        $this->hasil_imt = $data['hasil_imt'] ?? null;
        ...
        $this->risiko_lansia = $data['risiko_lansia'] ?? null;
        $this->risiko_ibu_hamil = $data['risiko_ibu_hamil'] ?? null;
        $this->risiko_dm = $data['risiko_dm'] ?? null;
        $this->risiko_hipertensi = $data['risiko_hipertensi'] ?? null;
        $this->risiko_hiv_aids = $data['risiko_hiv_aids'] ?? null;
        $this->gejala_batuk = $data['gejala_batuk'] ?? null;
        $this->gejala_bb_turun = $data['gejala_bb_turun'] ?? null;
        $this->gejala_demam_hilang_timbul = $data['gejala_demam_hilang_timbul'] ?? null;
        $this->gejala_lesu_malaise = $data['gejala_lesu_malaise'] ?? null;
        $this->gejala_berkeringat_malam = $data['gejala_berkeringat_malam'] ?? null;
        $this->gejala_pembesaran_getah_bening = $data['gejala_pembesaran_getah_bening'] ?? null;
